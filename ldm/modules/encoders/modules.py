...
class FrozenCLIPEmbedder(AbstractEncoder):
    ...
    def __init__(self, version="/home/haoli84/.cache/huggingface/transformers", device="cuda", max_length=77):
        super().__init__()
        self.tokenizer = CLIPTokenizer.from_pretrained("/home/haoli84/.cache/huggingface/transformers")
        self.transformer = CLIPTextModel.from_pretrained("/home/haoli84/.cache/huggingface/transformers")
        self.device = device
        self.max_length = max_length
        self.freeze()
