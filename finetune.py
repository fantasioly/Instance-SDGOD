...
def get_args_parser():
    ...
    parser.add_argument("--train_file", type=str, default="dataset/daytimeclear_train.txt", help="list of JSON files for model training")

    # count number of duplicated classes when making a sentence.
    parser.add_argument("--count_dup", type=lambda x: x.lower() == "true", default=True,
                        help="count number of duplicated classes")

    # count number of duplicated classes when making a sentence.
    parser.add_argument("--re_init_opt", type=lambda x: x.lower() == "true", default=True,
...
def main(args):
    ...
    config.total_batch_size = config.batch_size * ngpus
