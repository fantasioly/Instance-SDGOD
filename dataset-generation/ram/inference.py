...
def inference_tag2text_insert(image, model, input_tag="None", num_return_sequences=10):
    ...
    # If user input specified tags:
        ...
        with torch.no_grad():
            caption, input_tag = model.text_generate(image,
                                                insert_input=input_tag,
                                                max_length=50,
                                                return_tag_predict=True,
                                                sample=True,
        ...
        return tag_predict[0], input_tag[0], caption
